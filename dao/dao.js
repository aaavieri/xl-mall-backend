...
let dbParams = require('../config/dbConnection')
 ...
 */
var listSqlFunc = function (commonParams, sqlFuncs) {
...
var selectOneFunc = function (statement, params, callback) {
    ...
    this.bizCallback = function(error, results, fields, others) {
        ...
        callback.apply(null, [error, (!results || results.length == 0) ? null : results[0], fields, others])
    }
}
...
var selectListFunc = function (statement, params, callback) {
    baseFunc.apply(this, arguments)
    this.bizCallback = function(error, results, fields, others) {
        callback.apply(null, [error, !results ? [] : results, fields, others])
    }
}
...
var updateFunc = function (statement, params, callback) {
    baseFunc.apply(this, arguments)
    this.bizCallback = function(error, results, fields, others) {
        callback.apply(null, [error, results ? results.changedRows : null, others])
    }
}
